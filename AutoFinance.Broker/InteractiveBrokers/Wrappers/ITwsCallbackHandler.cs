...
#pragma warning disable SA1300 // Element must begin with upper-case letter
        ...
        void historicalData(int reqId, string date, double open, double high, double low, double close, int volume, int count, decimal WAP, bool hasGaps);
        ...
        void updateMktDepthL2(int tickerId, int position, string marketMaker, int operation, int side, double price, decimal size);
