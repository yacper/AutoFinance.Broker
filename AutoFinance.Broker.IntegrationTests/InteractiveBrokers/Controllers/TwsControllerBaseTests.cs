...
public class TwsControllerBaseTests
{
    ...
    public async Task HistoricalDataController_Should_RetrieveHistoricalData()
    {
        ...
        // Call
        List<HistoricalDataEventArgs> historicalDataEvents =
            await twsController.GetHistoricalDataAsync(contract, queryTime, TwsDuration.OneMonth, TwsBarSizeSetting.OneDay, TwsHistoricalDataRequestType.Midpoint);
    ...
    public async Task MarketDataTypeController_Should_ReturnMarketDataType()
    {
        ...
        MarketDataTypeEventArgs marketDataTypeEventArgs = null;
        TickPriceEventArgs      tickPriceEventArgs      = null;
        twsObjectFactory.TwsCallbackHandler.MarketDataTypeEvent += (sender, args) => { marketDataTypeEventArgs = args; };
        twsObjectFactory.TwsCallbackHandler.TickPriceEvent      += (sender, args) => { tickPriceEventArgs      = args; };
    ...
    public async Task CancelPnLController_Should_StopPnLEvent()
    {
        ...
        twsObjectFactory.TwsCallbackHandler.PnLEvent +=
            ...
            {
                pnlEventArgs            = args;
                pnlEventTriggerDateTime = DateTime.Now;
            };
